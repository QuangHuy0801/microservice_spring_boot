...
public class ForgotPasswordAdminActivity extends AppCompatActivity {
    ...
    private void tvLogin1Click() {
        tvLogin1.setOnClickListener(v -> {
            startActivity(new Intent(ForgotPasswordAdminActivity.this, LoginDashboardActivity.class));
        });
    }
    ...
    private void btnSubmitClick() {
        btnSubmit.setOnClickListener(view -> {
            ...
            ProgressDialog progressDialog = new ProgressDialog(ForgotPasswordAdminActivity.this);
            ...
            AdminAPI.adminApi.forgotPassword(user_id).enqueue(new Callback<String>() {
                @Override
                                ...
                                if(code.equals(codeForgot)){
                                    ...
                                    btnSubmitPassword.setOnClickListener(v -> {
                                        ...
                                        if (newPass.equals(reNewPass) && !newPass.isEmpty()){
                                            AdminAPI.adminApi.forgotNewPass(user_id, codeForgot, newPass).enqueue(new Callback<String>() {
                                                @Override
                                                public void onResponse(Call<String> call, Response<String> response) {
                                                    if (response.isSuccessful()){
                                                        Dialog dialog = new Dialog(ForgotPasswordAdminActivity.this);
...
//                                                        startActivity(new Intent(ForgotPasswordActivity.this, LoginActivity.class));
                                            ...
                                            Toast.makeText(ForgotPasswordAdminActivity.this, "Password and confirm password do not match!", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                    tvLogin3.setOnClickListener(v -> {
                                        startActivity(new Intent(ForgotPasswordAdminActivity.this, LoginActivity.class));
                                    });
                                }
                                else{
                                    tvCodeNotCorrect.setVisibility(View.VISIBLE);
                                    Toast.makeText(ForgotPasswordAdminActivity.this, "Your code is not correct!", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                        ...
                        Toast.makeText(ForgotPasswordAdminActivity.this, "Your username is not correct!", Toast.LENGTH_SHORT).show();
                    }}
                    else{
                        progressDialog.dismiss();
                        Toast.makeText(ForgotPasswordAdminActivity.this, "Đã có lỗi server", Toast.LENGTH_LONG).show();
                    }
                }
